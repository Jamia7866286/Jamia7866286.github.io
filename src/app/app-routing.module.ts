...
import { EditStudentDetailsComponent } from './Components/dashboard/edit-student-details/edit-student-details.component';
...
const routes: Routes = [
  ...
  { path: 'login', canActivate: [RedirectGuard] , component: LoginComponent},
  {
    ...
    children: [
      ...
      {
        path: 'editstudent', component: EditStudentDetailsComponent
      }
    ]
  }
];
